...
- **Payback estimates** — simulated years to repay a 100% debt-financed degree at the 6.39% federal rate, paying 20% of a salary that starts at entry level and grows 5%/year; adjustable net-cost slider (defaults to Bryant's published average net price), "50+" when interest outruns payments
