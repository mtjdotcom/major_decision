...
- **Payback estimates** — years to repay a 100% debt-financed degree with 20% of entry salary set aside each year, with an adjustable net-cost slider (defaults to Bryant's published average net price)
